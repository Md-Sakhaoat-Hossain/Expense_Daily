import 'package:expense_daily/models/category_model.dart';
import 'package:expense_daily/models/expense_model.dart';
import 'package:expense_daily/providers/app_provider.dart';
import 'package:expense_daily/utils/helper_function.dart';
import 'package:expense_daily/utils/widget_functions.dart';
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration:
                  InputDecoration(filled: true, labelText: 'Name Of Expense'),
                  validator: (value) {
                        ...
                        builder: (context, provider, child) =>
                            DropdownButtonFormField<CategoryModel>(
                              ...
                              items: provider.categoryList
                                  ...
                                  value: e,
                                  child: Text(e.name, style: TextStyle(color: e.name == 'All' ? Colors.cyan : Colors.black),),
                                ),
                              )
                                  .toList(),
                              onChanged: (value) {
